import { MergeConflictError, MergeFromBaseConflictError, NotGitRepoError, } from "../utils/checkout-git.js";
import { runGitCommand } from "../utils/run-git-command.js";
export const READ_ONLY_GIT_ENV = {
    ...process.env,
    GIT_OPTIONAL_LOCKS: "0",
};
export async function resolveCheckoutGitDir(cwd) {
    try {
...
//# sourceMappingURL=checkout-git-utils.js.map