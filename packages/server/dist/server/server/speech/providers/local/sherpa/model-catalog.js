...
export const SHERPA_ONNX_MODEL_CATALOG = {
    ...
    "kitten-nano-en-v0_1-fp16": {
        kind: "tts",
        archiveUrl: "https://github.com/k2-fsa/sherpa-onnx/releases/download/tts-models/kitten-nano-en-v0_1-fp16.tar.bz2",
...
const ALL_MODEL_IDS = Object.keys(SHERPA_ONNX_MODEL_CATALOG);
export const LOCAL_STT_MODEL_IDS = ALL_MODEL_IDS.filter((id) => SHERPA_ONNX_MODEL_CATALOG[id].kind !== "tts");
export const LOCAL_TTS_MODEL_IDS = ALL_MODEL_IDS.filter((id) => SHERPA_ONNX_MODEL_CATALOG[id].kind === "tts");
function resolveDefaultModelId(role) {
...
function createAliasedModelIdSchema(params) {
    ...
    return z
        ...
        .trim()
        .toLowerCase()
        .refine((value) => validIds.has(value) || Object.prototype.hasOwnProperty.call(params.aliases, value), {
...
export function listSherpaOnnxModels() {
    return ALL_MODEL_IDS.map((id) => ({
        id,
        ...SHERPA_ONNX_MODEL_CATALOG[id],
    }));
}
export function getSherpaOnnxModelSpec(id) {
