...
function flushBuffers(lines, buffers) {
...
function inputFromUnknownDetail(detail) {
 ...
 */
function collapseTimeline(items) {
    const result = [];
 ...
 */
export function curateAgentActivity(timeline, options) {
