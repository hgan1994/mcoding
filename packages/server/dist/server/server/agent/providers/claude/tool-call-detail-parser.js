import { z } from "zod";
import { ToolEditInputSchema, ToolEditOutputSchema, ToolReadInputSchema, ToolReadOutputSchema, ToolSearchInputSchema, ToolGrepOutputSchema, ToolGlobOutputSchema, ToolShellInputSchema, ToolShellOutputSchema, ToolWebFetchInputSchema, ToolWebFetchOutputSchema, ToolWebSearchOutputSchema, ToolWriteInputSchema, ToolWriteOutputSchema, toEditToolDetail, toFetchToolDetail, toReadToolDetail, toSearchToolDetail, toShellToolDetail, toWriteToolDetail, toolDetailBranchByName, } from "../tool-call-detail-primitives.js";
...
const ClaudeToolDetailPass2Schema = z.union([
    ...
    toolDetailBranchByName("WebSearch", ToolSearchInputSchema, ToolWebSearchOutputSchema.nullable(), (input, output) => toSearchToolDetail({ input, output, toolName: "web_search" })),
    toolDetailBranchByName("web_search", ToolSearchInputSchema, ToolWebSearchOutputSchema.nullable(), (input, output) => toSearchToolDetail({ input, output, toolName: "web_search" })),
    toolDetailBranchByName("search", ToolSearchInputSchema, z.unknown(), (input) => toSearchToolDetail({ input, toolName: "search" })),
    toolDetailBranchByName("Grep", ToolSearchInputSchema, ToolGrepOutputSchema.nullable(), (input, output) => toSearchToolDetail({ input, output, toolName: "grep" })),
    toolDetailBranchByName("grep", ToolSearchInputSchema, ToolGrepOutputSchema.nullable(), (input, output) => toSearchToolDetail({ input, output, toolName: "grep" })),
    toolDetailBranchByName("Glob", ToolSearchInputSchema, ToolGlobOutputSchema.nullable(), (input, output) => toSearchToolDetail({ input, output, toolName: "glob" })),
    toolDetailBranchByName("glob", ToolSearchInputSchema, ToolGlobOutputSchema.nullable(), (input, output) => toSearchToolDetail({ input, output, toolName: "glob" })),
    ...
    toolDetailBranchByName("webfetch", ToolWebFetchInputSchema, ToolWebFetchOutputSchema, toFetchToolDetail),
    toolDetailBranchByName("Skill", z.object({ skill: z.string() }).passthrough(), z
        .union([
        z
...
export function deriveClaudeToolDetail(name, input, output) {
...
//# sourceMappingURL=tool-call-detail-parser.js.map